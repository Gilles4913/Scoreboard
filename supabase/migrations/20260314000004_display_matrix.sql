...
VALUES
  ('rugby_stade',      'Rugby LED Stade',   'rugby',      'rugby_stade',
   '{"density":"low","show_rugby_score_breakdown":true,"show_live_overlays":true,"show_substitutions":true,"show_sin_bin":true,"show_cards":true}',
   true, true),
  ...
  ('rugby_club',       'Rugby Club',        'rugby',      'rugby_stade',
   '{"density":"low","show_rugby_score_breakdown":true,"show_live_overlays":true,"show_substitutions":false,"show_sin_bin":true,"show_cards":true}',
   false, true),
