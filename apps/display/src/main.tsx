...
function buildContextFromResponse(json: any): ScoreboardContext {
  ...
  return {
    ...
    show_rugby_penalties: resolved.show_rugby_penalties ?? sp.show_rugby_penalties ?? sportSettings.show_rugby_penalties ?? true,
    show_rugby_drop_goals: resolved.show_rugby_drop_goals ?? sp.show_rugby_drop_goals ?? sportSettings.show_rugby_drop_goals ?? true,
